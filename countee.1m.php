...
#  <xbar.var>select(VAR_IMPFZENTRUM="Dresden"): The vaccination center to be displayed directly in the status bar. [Annaberg, Belgern, Borna, Chemnitz, Dresden, Eich, Grimma, Kamenz, Dippoldiswalde, Leipzig, Löbau, Mittweida, Pirna, Plauen, Riesa, Zwickau]</xbar.var>
